...
export function EditExpenseModal({ open, onOpenChange, expense, participants }: EditExpenseModalProps) {
  ...
  useEffect(() => {
    ...
    setSelectedParticipants(expense.splits.map((split) => split.participant_id))
  }, [expense])
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Update the expense details and split information</DialogDescription>
        </DialogHeader>
